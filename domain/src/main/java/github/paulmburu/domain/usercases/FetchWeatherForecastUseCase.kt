...
typealias FetchWeatherForecastBaseUseCase = FlowBaseUseCase<Coordinates, Flow<Resource<List<WeatherForecast>>>>
...
class FetchWeatherForecastUseCase constructor(private val weatherRepository: WeatherRepository) :
    ...
    override fun invoke(params: Coordinates): Flow<Resource<List<WeatherForecast>>> = flow {
